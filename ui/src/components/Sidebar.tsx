    ...
    <aside className="w-60 h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/dashboard" label={t("sidebar.nav.dashboard")} icon={LayoutDashboard} liveCount={liveRunCount} />
          <SidebarNavItem
            to="/inbox"
        ...
        <SidebarSection label={t("sidebar.sections.work")}>
          ...
          <SidebarNavItem to="/routines" label={t("sidebar.nav.routines")} icon={Repeat} />
        ...
        <SidebarSection label={t("sidebar.sections.company")}>
          <SidebarNavItem to="/org" label={t("sidebar.nav.org")} icon={Network} />
          <SidebarNavItem to="/skills" label={t("sidebar.nav.skills")} icon={Boxes} />
          <SidebarNavItem to="/costs" label={t("sidebar.nav.costs")} icon={DollarSign} />
