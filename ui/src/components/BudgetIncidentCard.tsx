        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="text-[11px] uppercase tracking-[0.22em] text-red-200/80">
              {incident.scopeType} {t("costs.hardThreshold")}
            </div>
            ...
            <CardDescription className="mt-1 text-red-100/70">
              {t("costs.budgetLimit")} {formatCents(incident.amountObserved)} {t("costs.softThreshold")} {formatCents(incident.amountLimit)}.
            </CardDescription>
          </div>
        ...
        <div className="rounded-xl border border-border/60 bg-background/60 p-3">
          ...
          <div className="mt-2 flex flex-col gap-3 sm:flex-row">
            ...
            >
              ...
              {isMutating ? t("common.action.save") : t("common.action.save")}
            </Button>
          </div>
