...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("sidebar.mobile.home"), icon: House },
      { type: "link", to: "/issues", label: t("sidebar.mobile.issues"), icon: CircleDot },
      { type: "action", label: t("sidebar.mobile.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("sidebar.mobile.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
        label: t("sidebar.mobile.inbox"),
        icon: Inbox,
