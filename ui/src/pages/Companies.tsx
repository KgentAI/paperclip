...
export function Companies() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">{t("common.action.loading")}</p>}
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {agentCount} {agentCount === 1 ? t("agents.title") : t("agents.title")}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {issueCount} {issueCount === 1 ? t("issues.title") : t("issues.title")}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">{t("costs.budgetLimit")}</span>}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 ml-auto">
                  <Calendar className="h-3.5 w-3.5" />
                  <span>{t("common.time.daysAgo", { count: 0 }).replace("0d ago", relativeTime(company.createdAt))}</span>
                </div>
              </div>
