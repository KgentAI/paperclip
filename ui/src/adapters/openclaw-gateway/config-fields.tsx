    ...
    <>
      <Field label={t("adapters.gatewayUrl")} hint={help.webhookUrl}>
        <DraftInput
          ...
          placeholder={t("adapters.placeholders.gatewayUrl")}
        />
      </Field>
      ...
      {!isCreate && (
        <>
          <Field label={t("adapters.paperclipApiUrlOverride")}>
            <DraftInput
              value={
                eff(
                  "adapterConfig",
              ...
              immediate
              className={inputClass}
              placeholder={t("adapters.placeholders.paperclipApiUrl")}
            />
          </Field>

          <Field label={t("adapters.claimedApiKeyPath")}>
            <DraftInput
              ...
              immediate
              className={inputClass}
              placeholder={t("adapters.placeholders.claimedApiKeyPath")}
            />
          </Field>
          ...
          <Field label={t("adapters.sessionStrategy")}>
            <select
              ...
              className={inputClass}
            >
              <option value="fixed">{t("adapters.sessionStrategyOptions.fixed")}</option>
              <option value="issue">{t("adapters.sessionStrategyOptions.issue")}</option>
              <option value="run">{t("adapters.sessionStrategyOptions.run")}</option>
            </select>
          </Field>
          ...
          {sessionStrategy === "fixed" && (
            <Field label={t("adapters.sessionKey")}>
              <DraftInput
                ...
                immediate
                className={inputClass}
                placeholder={t("adapters.placeholders.sessionKey")}
              />
            </Field>
          )}
          ...
          <SecretField
            ...
            placeholder={t("adapters.openClawGatewayToken")}
          />
          ...
          <Field label={t("adapters.role")}>
            <DraftInput
              ...
              immediate
              className={inputClass}
              placeholder={t("adapters.placeholders.role")}
            />
          </Field>
          ...
          <Field label={t("adapters.scopes")}>
            <DraftInput
              ...
              immediate
              className={inputClass}
              placeholder={t("adapters.placeholders.scopes")}
            />
          </Field>

          <Field label={t("adapters.waitTimeoutMs")}>
            <DraftInput
              ...
              immediate
              className={inputClass}
              placeholder={t("adapters.placeholders.waitTimeoutMs")}
            />
          </Field>

          <Field label={t("adapters.deviceAuth")}>
            <div className="text-xs text-muted-foreground leading-relaxed">
              {t("adapters.deviceAuthDescription")}
            </div>
          </Field>
        </>
      )}
